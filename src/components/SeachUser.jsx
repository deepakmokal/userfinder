...
const SeachUser = () => {
  ...
  return (
    <div className="px-2 pb-6 pt-3 my-6 border rounded">
      <p className="text-3xl text-slate-900 font-medium mb-1">
        Search GitHub Users
      </p>
      ...
      <div className="mt-3">
        <div className="flex">
          <span className="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-r-0 border-gray-300 rounded-l-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
            ...
            <span className="mx-2 text-slate-500">Username</span>
          </span>
          <input
            type="text"
            id="website-admin"
